...
const Home = () => {
  ...
  const [masterpiecesRef, masterpiecesVisible] = useElementOnScreen({ threshold: 0.1 });
    ...
    <div className="md:max-w-7xl mx-auto p-5 space-y-16">
      ...
      <div className="gap-8 flex flex-col items-center md:flex-row py-6 sm:py-12">
        <div className="flex flex-col items-center text-center md:text-start md:items-baseline space-y-6 md:w-1/2">
          <div className="px-4 py-1.5 font-medium flex items-center gap-2 text-[#795D43] bg-[#FED9B8] rounded-full shadow-xs">
            <CakeIcon size={16} />
            <span className="text-xs uppercase tracking-wider font-semibold">Best Custom Cakes in Town</span>
          </div>
          <h1 className="font-heading text-primary font-extrabold text-4xl sm:text-5xl lg:text-6xl leading-tight">
            Sweet Cakes Made with <span className="text-[#ffb7c5] relative inline-block">Love <span className="absolute bottom-1 left-0 w-full h-1 bg-[#ffb7c5]/50 -z-5 rounded-full"></span></span> by Kuya Jon
          </h1>
          <p className="font-medium text-gray-600 text-base sm:text-lg max-w-lg leading-relaxed">
            Custom cakes for birthdays, weddings, and special moments. Each creation is a hand-crafted masterpiece designed to bring a smile to your face.
          </p>
        ...
        <div className="md:w-1/2 flex justify-center p-5 relative">
          ...
          <img src={heroImage} alt="Beautiful Cake Design" className="w-full max-w-md animate-float" />
        </div>
      </div>

      {/* Features Grid */}
      <div ref={featuresRef} className={`grid grid-cols-1 sm:grid-cols-3 gap-8 bg-white/60 backdrop-blur-xs p-8 rounded-3xl border border-soft shadow-soft transition-all duration-1000 ${
        ...
        <div className="flex flex-col items-center text-center p-4 space-y-3">
          ...
          <h3 className="font-heading font-bold text-gray-800 text-lg">Baked with Love</h3>
          <p className="text-gray-600 text-sm">Every single ingredient is premium and handled with utmost care for perfect taste.</p>
        </div>
        <div className="flex flex-col items-center text-center p-4 space-y-3">
          <div className="p-3 bg-[#fed9b8]/30 rounded-2xl text-[#74593f]">
            <Clock size={24} />
          </div>
          <h3 className="font-heading font-bold text-gray-800 text-lg">Fresh & On Time</h3>
          <p className="text-gray-600 text-sm">We prepare your orders fresh from the oven, arriving exactly when you need them.</p>
        </div>
        <div className="flex flex-col items-center text-center p-4 space-y-3">
          <div className="p-3 bg-emerald-50 rounded-2xl text-emerald-700">
            <Truck size={24} />
          </div>
          <h3 className="font-heading font-bold text-gray-800 text-lg">Safe Delivery</h3>
          <p className="text-gray-600 text-sm">Special delivery boxes and cooling setups ensure your cakes arrive perfectly intact.</p>
        </div>
      </div>

      {/* Masterpieces Section */}
      <div ref={masterpiecesRef} className={`transition-all duration-1000 ${
        masterpiecesVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
      }`}>
        <div className="my-8 text-center">
          <span className="px-3 py-1 text-xs font-semibold uppercase tracking-wider text-[#864e5a] bg-[#ffb7c5]/30 rounded-full">
            Featured Creations
          </span>
          <h2 className="font-heading text-primary text-3xl font-bold md:text-4xl lg:text-5xl mt-3">Our Masterpieces</h2>
      ...
      <div ref={pricingRef} className="py-8">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500 font-medium mt-2">A slice of happiness for every budget</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto px-2 items-stretch">
          ...
          >
            ...
            <div className="text-center space-y-6">
              ...
              <div className="space-y-1">
                <h3 className="font-heading text-2xl font-bold text-gray-800 transition-colors group-hover:text-[#2E5A44]">Mini Treats</h3>
                <p className="text-[#a66b74] font-semibold text-base">Starting at ₱450</p>
              </div>
              {/* Features */}
              <ul className="space-y-3 text-gray-600 text-sm py-4 border-t border-gray-50">
                <li className="transition-transform duration-300 group-hover:translate-x-1">6-inch Small Cakes</li>
                <li className="transition-transform duration-300 group-hover:translate-x-1">Classic Flavor Options</li>
                <li className="transition-transform duration-300 group-hover:translate-x-1">Simple Icing Design</li>
              </ul>
            </div>
            
            <button
              onClick={() => navigate("/pricing?size=6+inch&tiers=1&flavor=Vanilla")}
          ...
          >
            ...
            <div className="text-center space-y-6">
              ...
              <div className="space-y-1">
                <h3 className="font-heading text-2xl font-bold text-gray-800 transition-colors group-hover:text-[#7F4852]">Celebration Cakes</h3>
                <p className="text-[#864e5a] font-bold text-base">Starting at ₱1,200</p>
              </div>
              {/* Features */}
              <ul className="space-y-3 text-gray-600 text-sm py-4 border-t border-gray-50">
                <li className="transition-transform duration-300 group-hover:translate-x-1">Standard 8-10 inch</li>
                <li className="transition-transform duration-300 group-hover:translate-x-1">Custom Theme Designs</li>
                <li className="transition-transform duration-300 group-hover:translate-x-1">Premium Fillings</li>
                <li className="transition-transform duration-300 group-hover:translate-x-1">Hand-painted Details</li>
              </ul>
            </div>
            
            <button
              onClick={() => navigate("/pricing?size=8+inch&tiers=1&flavor=Chocolate")}
          ...
          >
            ...
            <div className="text-center space-y-6">
              ...
              <div className="space-y-1">
                <h3 className="font-heading text-2xl font-bold text-gray-800 transition-colors group-hover:text-[#7E5B3D]">Custom Masterpieces</h3>
                <p className="text-[#7E5B3D] font-semibold text-base">Contact for Quote</p>
              </div>
              {/* Features */}
              <ul className="space-y-3 text-gray-600 text-sm py-4 border-t border-gray-50">
                <li className="transition-transform duration-300 group-hover:translate-x-1">Tiered Sculptural Cakes</li>
                <li className="transition-transform duration-300 group-hover:translate-x-1">Complex Sugar Art</li>
                <li className="transition-transform duration-300 group-hover:translate-x-1">Special Event Set-up</li>
              </ul>
            </div>
      ...
      {/* Sweet CTA Section */}
      <div ref={ctaRef} className={`bg-gradient-to-br from-[#864e5a] to-[#74593f] rounded-[2.5rem] p-8 sm:p-12 text-[#FBF9F1] text-center space-y-6 relative overflow-hidden shadow-soft transition-all duration-1000 ${
        ...
        <p className="text-[#ffb7c5] max-w-md mx-auto text-sm sm:text-base leading-relaxed">
          Order a pre-designed cake from our gallery or use our builder to create a personalized cake in real-time.
        </p>
